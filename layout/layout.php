...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .topbar a { color: #c8e6a0; text-decoration: none; }
        ...
        .btn-membership:hover { background: #2a5010; }
        .btn-membership .highlight { color: #b8e05a; }
        ...
        .btn-nav-link:hover { color: var(--green-main); }
        ...
        .btn-signup:hover { color: var(--green-main); }
        .btn-login {
            background: none;
            color: var(--text-dark);
        }
        .btn-login:hover { color: var(--green-main); }
        ...
        .cart-btn:hover { color: var(--green-main); }
        .cart-count {
            position: absolute;
            top: -2px; right: 2px;
            background: #e03030;
        ...
        .delivery-links a:hover { color: var(--green-main); }
        ...
        .cat-item:hover { background: var(--green-bg); color: var(--green-main); }
        .cat-item .arrow { color: #aaa; font-size: 11px; }
        ...
        .landers-input:focus { border-color: var(--green-main); }
        .btn-landers-green {
            width: 100%;
            background: var(--green-main);
            color: #fff;
        ...
        .btn-landers-green:hover { background: var(--green-dark); }
        .forgot-link {
            color: var(--green-main);
            font-size: 13px;
            font-weight: 600;
        ...
        .social-btn:hover { border-color: #999; color: var(--text-dark); }
        .pw-rules {
            font-size: 12px;
            color: #aaa;
            list-style: none;
        ...
        .pw-rules li.ok { color: var(--green-main); }
        .membership-toggle {
            display: flex;
            gap: 8px;
            margin-bottom: 14px;
        ...
        .toggle-yes.active { background: var(--green-main); color: #fff; border-color: var(--green-main); }
        .toggle-no.active { background: #fff; color: var(--text-dark); border-color: #ddd; }
        ...
        .site-footer a { color: #a0cc70; font-size: 13px; text-decoration: none; display: block; margin-bottom: 6px; }
    ...
    <div class="nav-inner">
        ...
        <div class="nav-actions">
            ...
            <?php if (isset($_SESSION['account_id'])): ?>
                <!-- Logged in -->
                <div class="dropdown">
                    <button class="btn dropdown-toggle user-dropdown"
            ...
            <?php else: ?>
                <!-- Guest -->
                <button class="btn-signup" data-bs-toggle="modal" data-bs-target="#authModal" onclick="switchTab('signup')">
                    Sign Up
                </button>
                <button class="btn-login" data-bs-toggle="modal" data-bs-target="#authModal" onclick="switchTab('login')">
                    Login
                </button>
            <?php endif; ?>
        </div>
...
<div class="delivery-bar">
    <div class="delivery-bar-inner">
        ...
        <div class="delivery-links">
            ...
            <a href="#" style="border:1.5px solid var(--green-main);border-radius:20px;padding:3px 12px;color:var(--green-main);">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:520px;">
        <div class="modal-content p-4">
            ...
            <button type="button" class="btn-close position-absolute"
                    style="top:16px;right:16px;" data-bs-dismiss="modal"></button>
            ...
            <div id="panelSignup">
                <form method="POST" action="/landersonline/auth/register.php">
                    ...
                    <div style="position:relative;">
                        <input type="password" name="password" id="regPw" class="landers-input" placeholder="Enter Password" required>
                    ...
                    <div style="position:relative;">
                        <input type="password" name="confirm_password" id="regPw2" class="landers-input" placeholder="Confirm Password" required>
                    ...
                    <!-- Membership -->
                    <p style="font-size:13px;margin-bottom:8px;">Are you a Landers membership card holder?</p>
                    <div class="membership-toggle">
                        <button type="button" class="toggle-yes active" onclick="toggleMembership(true)">Yes</button>
                        <button type="button" class="toggle-no" onclick="toggleMembership(false)">No</button>
                    </div>

                    <div id="membershipFields">
                        <div style="margin-bottom:10px;">
                            <label style="font-size:13px;cursor:pointer;">
                                <input type="radio" name="card_type" value="landers" checked> Landers membership card
                            </label>
                            &nbsp;&nbsp;
                            <label style="font-size:13px;cursor:pointer;">
                                <input type="radio" name="card_type" value="caltex"> Caltex Starcard Member
                            </label>
                        </div>
                        <input type="text" name="card_number" class="landers-input" placeholder="Membership Card Number">
                        <input type="text" name="card_name" class="landers-input" placeholder="Printed Name on Membership card (First & Last Name)">
                    </div>
                    ...
                    <div style="display:flex;align-items:center;gap:10px;margin:12px 0;">
                        <hr style="flex:1;"> <span style="font-size:13px;color:#aaa;">Or, sign up with</span> <hr style="flex:1;">
                    </div>
                    <div style="display:flex;gap:10px;">
                        <a href="#" class="social-btn" style="flex:1;">
                            <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/facebook.svg" width="18" style="filter:invert(28%) sepia(80%) saturate(900%) hue-rotate(200deg);"> Facebook
                        </a>
                        <a href="#" class="social-btn" style="flex:1;">
                            <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/google.svg" width="18"> Google
                        </a>
                    </div>
                </form>
            </div>
            ...
            <div id="panelLogin" style="display:none;">
                <form method="POST" action="/landersonline/auth/login.php">
                    ...
                    <div style="position:relative;">
                        <input type="password" name="password" id="loginPw" class="landers-input" placeholder="Enter Password" required>
                    ...
                    <div style="display:flex;align-items:center;gap:10px;margin:12px 0;">
                        <hr style="flex:1;"> <span style="font-size:13px;color:#aaa;">Or, login with</span> <hr style="flex:1;">
                    </div>
                    <div style="display:flex;gap:10px;">
                        <a href="#" class="social-btn" style="flex:1;">
                            <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/facebook.svg" width="18" style="filter:invert(28%) sepia(80%) saturate(900%) hue-rotate(200deg);"> Facebook
