...
<div style="display:flex;max-width:1300px;margin:0 auto;padding:0 0 0 0;">
    ...
    <div class="category-sidebar">
        <?php if ($categories && $categories->num_rows > 0): ?>
            ...
            <a href="/landersonline/customer/shop.php?cat=<?= $cat['Cat_Id'] ?>"
               class="cat-item">
    ...
    <div style="flex:1;padding:20px 24px;overflow:hidden;">
        ...
        <div style="background:linear-gradient(135deg,#3a6b1a 0%,#6aaf35 100%);
            ...
            <a href="/landersonline/customer/shop.php"
               style="background:#1a2e0a;color:#fff;padding:12px 28px;border-radius:6px;
        ...
        <div style="background:var(--green-main);border-radius:10px;padding:22px 32px;
            ...
            <a href="/landersonline/customer/shop.php"
               style="background:#fff;color:var(--green-dark);padding:10px 22px;
            ...
            <?php if ($products && $products->num_rows > 0): ?>
                ...
                <div class="product-card">
                    <?php if ($prod['Prod_OldPrice'] && $prod['Prod_OldPrice'] > $prod['Prod_Price']): ?>
                        <?php
                        $disc = round((1 - $prod['Prod_Price'] / $prod['Prod_OldPrice']) * 100);
                        ?>
...
<footer class="site-footer">
    <div style="max-width:1300px;margin:0 auto;padding:0 24px;">
        <div class="row">
            <div class="col-md-3">
                <h6>LandersOnline</h6>
                <p style="font-size:13px;color:#a0cc70;">Your trusted online supermarket delivering quality products to your doorstep.</p>
            </div>
            <div class="col-md-2">
                <h6>Shop</h6>
            ...
            <div class="col-md-3">
                ...
                <a href="#" style="display:inline-block;background:#1a2e0a;color:#fff;padding:8px 16px;border-radius:6px;margin-bottom:8px;font-size:12px;">
                    <i class="bi bi-apple me-2"></i>App Store
                </a><br>
                <a href="#" style="display:inline-block;background:#1a2e0a;color:#fff;padding:8px 16px;border-radius:6px;font-size:12px;">
